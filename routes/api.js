...
module.exports = function (app) {
  ...
  app
    ...
    .post(async function (req, res) {
      ...
      try {
        ...
        const newThread = new Thread({
          board,
          text,
          delete_password: hashedPassword,  // ← FIXED: Use hashed password
          created_on: new Date(),
          bumped_on: new Date(),
          reported: false,
          replies: [],
    ...
    // GET - Get 10 most recent threads with 3 most recent replies each
    .get(async function (req, res) {
      ...
      try {
        ...
        threads.forEach((thread) => {
          // FIXED: Sort replies by created_on DESC, then take first 3 (most recent)
    ...
    // DELETE - Delete thread with password verification
    .delete(async function (req, res) {
      ...
      try {
        ...
        // FIXED: Compare with bcrypt instead of plain text
  ...
  app
    ...
    .post(async function (req, res) {
      ...
      try {
        ...
        // FIXED: Hash reply password before saving
        const hashedPassword = await bcrypt.hash(delete_password, 10);
    ...
    // GET - Get single thread with all replies
    .get(async function (req, res) {
      const { board } = req.params;
    ...
    // DELETE - Delete reply (changes text to [deleted])
    .delete(async function (req, res) {
      const { board } = req.params;
